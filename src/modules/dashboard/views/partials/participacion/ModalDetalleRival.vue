  ...
  >
    <div v-if="burbuja" class="flex flex-col gap-5 py-1">
      ...
      <div class="space-y-3 bg-white dark:bg-slate-800/60 rounded-xl border border-slate-200/80 dark:border-slate-700/60 p-4 divide-y divide-slate-100 dark:divide-slate-700">
        ...
        <div v-if="!props.esVistaRival && burbuja.partido.estado !== 'jugado' && burbuja.codigoSeguridadPropio" class="flex flex-col gap-1 py-2">
          ...
          <p class="text-[10px] text-slate-400 dark:text-slate-500 italic text-right">
            🔒 Dicta este código de 5 dígitos al árbitro en la mesa para iniciar tu partido oficial.
          </p>
        </div>
